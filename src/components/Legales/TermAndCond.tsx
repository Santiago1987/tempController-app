  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        ofrecerle acceso al Servicio (como se define más abajo), sujeto a estos
        términos y condiciones (los "Términos de Servicio") y a la Política de
        Privacidad correspondiente de{" "}
        <span style={{ fontWeight: "bold" }}>C.I.D.I.F.</span>. Al acceder y
        utilizar el Servicio, usted expresa su consentimiento, acuerdo y
        entendimiento de los Términos de Servicio y la Política de Privacidad.
        Si no está de acuerdo con los Términos de Servicio o la Política de
        Privacidad, no utilice el Servicio. Si utiliza el servicio está
        aceptando las modalidades operativas en vigencia descriptas más
        adelante, las declara conocer y aceptar, las que se habiliten en el
        futuro y en los términos y condiciones que a continuación se detallan:
      </p>
      <p className="h2">Operaciones habilitadas</p>
      <p>
      ...
      <p className="h3">Costo del Servicio</p>
      <p>
        La empresa <span style={{ fontWeight: "bold" }}>C.I.D.I.F.</span>. podrá
        cobrar comisiones por el mantenimiento y/o uso de este Servicio o los
        que en el futuro implemente, entendiéndose facultado expresamente para
        efectuar los correspondientes débitos en mis cuentas, aún en
        descubierto, por lo que presto para ello mi expresa conformidad. En caso
        de cualquier modificación a la presente previsión, lo comunicará con al
        menos 60 días de antelación.
      </p>
      <p className="h3">Validez de operaciones y notificaciones</p>
      <p>
      ...
      <p className="h3">Propiedad intelectual</p>
      <p>
      ...
      <p className="h3">Privacidad de la información</p>
      <p>
        Para utilizar los Servicios ofrecidos por{" "}
        <span style={{ fontWeight: "bold" }}>C.I.D.I.F.</span>, los Usuarios
